...
// 질문 카테고리 정의 (중복 선언 방지)
if (typeof window.QUESTION_CATEGORIES === 'undefined') {
    ...
    var QUESTION_CATEGORIES = window.QUESTION_CATEGORIES;
}

// 성격 유형 정의 (중복 선언 방지)
if (typeof window.PERSONALITY_TYPES === 'undefined') {
    ...
    var PERSONALITY_TYPES = window.PERSONALITY_TYPES;
}
...
if (typeof window.questions === 'undefined') {
    const questions = [
    {
        ...
        text: {
            "ko": "친구들과 함께 있을 때 나는?",
            "en": "When I'm with friends, I?",
            "es": "Cuando estoy con amigos, yo?",
            "zh": "和朋友在一起时，我？",
            "hi": "जब मैं दोस्तों के साथ होता हूं, तो मैं?"
        },
    ...
    var personalityDescriptions = window.personalityDescriptions;
}